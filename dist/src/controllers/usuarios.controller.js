...
exports.eliminarOrdenes = exports.eliminarCarrito = exports.añadirOrden = exports.eliminarProductoListaDeseos = exports.eliminarProductoCarrito = exports.añadirMiCarrito = exports.añadirMiListaDeDeseos = exports.crearUsuario = exports.obtenerUsuarios = exports.obtenerUsuarioPorId = exports.obtenerUsuario = void 0;
...
const eliminarCarrito = (req, res) => {
    usuario_schema_1.Usuarioschema.findById(req.params.id)
        .then(usuario => {
        if (usuario) {
            usuario.miCarrito.splice(0, usuario.miCarrito.length);
            usuario.save();
            res.send(usuario);
        }
    })
...
const eliminarOrdenes = (req, res) => {
    usuario_schema_1.Usuarioschema.findById(req.params.id)
        .then(usuario => {
        if (usuario) {
            usuario.ordenes.splice(0, usuario.ordenes.length);
            usuario.save();
            res.send(usuario);
        }
    })
...
exports.eliminarOrdenes = eliminarOrdenes;
